...
def main():
    ...
    try:
        ...
        s_eyes = EyesService(service_id_eyes, param_eyes, face)
        s_mouth = MouthService(service_id_mouth, param_mouth, face)
        s_nose = NoseService(service_id_nose, param_nose, face)
