...
class SpeakerMistyServicePytree(py_trees.behaviour.Behaviour):
    ...
    def __init__(self, name = "SpeakerServicePytree"):
        ...
        super(SpeakerMistyServicePytree, self).__init__(name)
        ...
        if self.send_request:
            ...
            if new_state == GoalStatus.ACTIVE:
                ...
                if self.client_result is not None:
                    self.service_client_speaker.result = self.blackboard_tts.result
                    self.client_result = None
