...
from harmoni_face.misty_face_service import EyesService, MouthService
...
class LipSyncMistyServicePytree(py_trees.behaviour.Behaviour):
    def __init__(self, name):
        ...
        super(LipSyncMistyServicePytree, self).__init__(name)
